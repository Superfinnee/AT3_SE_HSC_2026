...
lineStations = {
    'M1': [
        ...
        'Cherrybrook', 'Castle Hill', 'Bella Vista', 'Epping',
    ...
    'T1': [
        ...
        'Berowra', 'Mount Kuring-gai', 'Mount Colah', 'Asquith', 'Hornsby',
        'Waitara', 'Wahroonga', 'Warrawee', 'Turramurra', 'Pymble', 'Gordon',
        'Killara', 'Lindfield', 'Roseville', 'Chatswood', 'Artarmon',
        'St Leonards', 'Wollstonecraft', 'Waverton', 'North Sydney', 'Milsons Point',
        # City
        'Wynyard', 'Town Hall', 'Central', 'Redfern',
        # Main Western
        'Strathfield', 'Lidcombe', 'Auburn', 'Clyde', 'Granville', 'Harris Park',
        'Parramatta', 'Westmead', 'Pendle Hill', 'Wentworthville', 'Toongabbie',
        'Seven Hills', 'Blacktown',
        # Richmond branch
        'Marayong', 'Quakers Hill', 'Schofields', 'Riverstone', 'Vineyard',
        'Mulgrave', 'Windsor', 'Clarendon', 'East Richmond', 'Richmond',
        # Emu Plains branch
        'Doonside', 'Rooty Hill', 'Mount Druitt', 'St Marys', 'Werrington',
        'Kingswood', 'Penrith', 'Emu Plains',
    ],
    'T2': [
        # City Circle
        'Circular Quay', 'Wynyard', 'Town Hall', 'Museum', 'St James', 'Central',
        # Inner West
        'Redfern', 'Macdonaldtown', 'Newtown', 'Stanmore', 'Petersham',
        'Lewisham', 'Summer Hill', 'Ashfield', 'Croydon', 'Burwood',
        'Strathfield', 'Homebush', 'Flemington', 'Lidcombe',
        # Western via Parramatta to Leppington
        'Auburn', 'Clyde', 'Granville', 'Harris Park', 'Parramatta',
        'Merrylands', 'Guildford', 'Yennora', 'Fairfield', 'Canley Vale',
        'Cabramatta', 'Warwick Farm', 'Liverpool', 'Casula',
    ...
    'T3': [
        ...
        'Strathfield', 'Homebush', 'Flemington', 'Lidcombe',
        # Bankstown direction
        'Berala', 'Regents Park', 'Sefton', 'Chester Hill', 'Leightonfield',
        'Villawood', 'Carramar', 'Cabramatta', 'Warwick Farm', 'Liverpool',
    ],
    'T4': [
        # Eastern Suburbs
        'Bondi Junction', 'Edgecliff', 'Kings Cross', 'Martin Place',
        'Town Hall', 'Central',
        # Illawarra
        'Redfern', 'Sydenham', 'Tempe', 'Wolli Creek', 'Arncliffe', 'Banksia',
        'Rockdale', 'Carlton', 'Allawah', 'Kogarah', 'Hurstville', 'Penshurst',
        'Mortdale', 'Oatley', 'Como', 'Jannali', 'Sutherland',
        # Cronulla branch
    ...
    'T5': [
        # Cumberland Line: Richmond to Leppington
        ...
        'Liverpool', 'Casula', 'Edmondson Park', 'Leppington',
    ],
    'T6': [
        'Lidcombe', 'Berala', 'Regents Park', 'Birrong', 'Yagoona', 'Bankstown',
    ],
    'T7': [
        'Central', 'Strathfield', 'Lidcombe', 'Olympic Park',
    ],
    'T8': [
        # City Circle
        'Circular Quay', 'Wynyard', 'Town Hall', 'Museum', 'St James', 'Central',
        # Via Airport
        'Redfern', 'Sydenham', 'Erskineville', 'St Peters', 'Green Square',
        'Mascot', 'Domestic Airport', 'International Airport', 'Wolli Creek',
        # South
        'Turrella', 'Bardwell Park', 'Bexley North', 'Beverly Hills', 'Narwee',
        'Kingsgrove', 'Riverwood', 'Padstow', 'Revesby', 'East Hills', 'Panania',
        'Glenfield', 'Macquarie Fields', 'Ingleburn', 'Minto', 'Leumeah',
        'Campbelltown', 'Macarthur',
        # Holsworthy branch
        'Holsworthy',
    ],
    'T9': [
        # Northern Line loop: North Shore → City → Epping line → back to Hornsby
        'Hornsby', 'Waitara', 'Wahroonga', 'Warrawee', 'Turramurra', 'Pymble',
        'Gordon', 'Killara', 'Lindfield', 'Roseville', 'Chatswood', 'Artarmon',
        'St Leonards', 'Wollstonecraft', 'Waverton', 'North Sydney', 'Milsons Point',
        'Wynyard', 'Town Hall', 'Central', 'Redfern', 'Strathfield', 'Burwood',
        'Concord West', 'Rhodes', 'Meadowbank', 'West Ryde', 'Denistone',
        'Eastwood', 'Epping', 'Cheltenham', 'Beecroft', 'Pennant Hills',
